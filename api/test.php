...
if (isset($video_id)) {
    $sql = "INSERT INTO resourcesmaster_01_copy1 (Subject, Category, TopicName, Resources, `Resource Type`, Notes, ConceptualRating, `LevelOfDifficulty`) VALUES ('$subject', '$category', '$topicname', '$resources', $restype, '$notes', $rating, $difficulty)";
} else {
    $sql = "INSERT INTO resourcesmaster_01_copy1 (Subject, Category, TopicName, Resources, `Resource Type`, Notes, ConceptualRating, `LevelOfDifficulty`) VALUES ('$subject', '$category', '$topicname', '$resources', $restype, '$notes', $rating, $difficulty)";
}
...
if (
  isset($parts["host"]) &&  ($parts["host"] == "www.youtube.com" || $parts["host"] == "youtu.be") && // include both formats
